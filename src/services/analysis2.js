 ...
 *  - Accuracy is the Chess.com exponential formula over average CP loss.
...
class AnalysisQueue {
    ...
    #tryResolveMove(
        ...
        // Chess.com accuracy uses average CENTIPAWN loss, not WP loss.
        // cpLoss = 0 when the played move is the engine's best (or better).
        const cpLoss = (isEngineBestMove || isBook)
            ? 0
            : ChessMath.cpLoss(stateBefore.wp, stateAfter.wp, isWhiteMove);

        finalMoveData[ply] = { isWhiteMove, cpLoss, isBook };
